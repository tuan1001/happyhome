...
void main() async {
  ...
  FirebaseMessaging.onMessage.listen((RemoteMessage message) {
    ...
    if (message.notification != null) {
      ...
      showRToast(message: message.notification!.title ?? 'You have new notification', gravity: ToastGravity.TOP);
    }
  });
    ...
    return MaterialApp(
      home: MultiBlocProvider(
        providers: [
          ...
          BlocProvider(create: (context) => BlocRequest(context: context)),
          BlocProvider(create: (context) => BlocTrainning(context: context)),
        ],

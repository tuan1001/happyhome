...
class User {
  ...
  factory User.fromMap(Map<String, dynamic> map) {
    return User(
      ...
      passwordhash: map['password_hash'] != null ? map['password_hash'] as String : '',
      email: map['email'] != null ? map['email'] as String : '',
      authKey: map['auth_key'] != null ? map['auth_key'] as String : '',
      status: map['status'] != null ? map['status'] as int : 0,
      profileImageUrl: map['anh_nguoi_dung'] != null ? map['anh_nguoi_dung'] as String : '',
      createdAt: DateTime.tryParse(map['created_at'] ?? ''),
      updatedAt: DateTime.tryParse(map['updated_at'] ?? ''),
      frontIDPhoto: map['anh_truoc_cccd'] != null ? map['anh_truoc_cccd'] as String : '',
      group: map['nhom'] != null ? map['nhom'] as String : '',
      backIDPhoto: map['anh_sau_cccd'] != null ? map['anh_sau_cccd'] as String : '',
      name: map['hoten'] != null ? map['hoten'] as String : '',
      phone: map['dien_thoai'] != null ? map['dien_thoai'] as String : '',
      identityNumber: map['cmnd'] != null ? map['cmnd'] as String : '',
      address: map['dia_chi'] != null ? map['dia_chi'] as String : '',
      active: map['kich_hoat'] != null ? map['kich_hoat'] as String : '',

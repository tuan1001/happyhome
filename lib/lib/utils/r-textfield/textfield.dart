...
class _RTextFieldState extends State<RTextField> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: widget.type == RTextFieldType.multiline ? 60 : 40,
      ...
      child: TextField(
        ...
        maxLines: widget.type == RTextFieldType.multiline ? null : 1,
        expands: widget.type == RTextFieldType.multiline,
        textAlignVertical: widget.type != RTextFieldType.multiline ? null : TextAlignVertical.top,
        ...
        textInputAction: widget.type == RTextFieldType.multiline ? TextInputAction.newline : TextInputAction.next,
        decoration: InputDecoration(
          counterText: '',
          contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: getInputType() == TextInputType.multiline ? 8 : 0),
          // hintText: label,
          alignLabelWithHint: widget.type == RTextFieldType.multiline,

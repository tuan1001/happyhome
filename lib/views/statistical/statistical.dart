      ...
      Container(
        ...
        child: Column(
          children: [
            ...
            RTitleAndText(title: 'Hoa hồng trong tháng', text: statisticalData?['vi_dien_tu'] ?? '0', underline: true),
            ...
            RTitleAndText(title: 'Số dư còn lại', text: statisticalData?['tong_xu'] ?? '0', underline: true),
          ],
        ),
      ),
